...
print('\27[0;31m☩━━━━━☩🌠𝘏𝘔𝘚🌠☩━━━━━☩n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end 
os.execute('lua DRAGON.lua')
end
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Gold-So/hms/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1804133252,916165019,11751768178}   
...
elseif tonumber(user_id) == tonumber(916165019) then
var = 'مطور السورس'
...
local UserName = (data.username_ or "hms_00")
...
os.execute('wget https://raw.githubusercontent.com/Gold-So/hms/main/DRAGON.lua')
...
send(msg.chat_id_, msg.id_,' ⋆ اصدار سورس همس{ S:12✓}')
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/hms_00/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '• ━━━━━━❪الركن الاخير❫━━━━━━ •' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس همس ادخل وتابع الجديد](t.me/hms_00)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝘏𝘔𝘚', url="t.me/hms_00"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/hms_00/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/hms_00)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/hms_00"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'المبرمج احمد المصريمبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
「المبرمج المبرمج احمد المصريلو حابب تتواصل معاه
اتبع الزر إلى تحت ↓」
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
send(msg.chat_id_,0," ⋆ الـعـضو  : {["..data.first_name_.."](T.ME/hms_00)}\n ⋆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⋆ عذرا  ↚ {["..data.first_name_.."](T.ME/hms_00)}\n ⋆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[ 
╭━━━━━❲☆[𝗛𝗺𝘀](t.me/hms_00)☆❳━━━━━╮
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙼𝚂](t.me/hms_00)
[𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽❳ ❲𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/hms_00)
╰━━━━━❲☆[𝗛𝗺𝘀](t.me/hms_00)☆❳━━━━━╯
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = '𝑯𝑴𝑺',url="t.me/hms_01"}},
{{text = '𝗛𝗺𝘀', url="t.me/hms_00"}},
}
local msg_id = msg.id_/2097152/0.5 
...
keyboard.inline_keyboard = {
{{text = '𝑯𝑴𝑺',url="t.me/hms_01"}},
{{text = '𝗦𝗼𝘂𝗿𝗰𝗲 𝗛𝗺𝘀', url="t.me/hms_00"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/hms_00/29&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'احمدالمصري' or text == 'احمد' or text == 'مبرمج السورس' then
local Text = [[
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DEV_AH8/11&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'همس'  then
local Text = [[
كريم مطور سورس همس للتواصل معه اتبع الزر الاسفل 👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑯𝑴𝑺🌠',url="t.me/hms_01"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/hms_01&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"تكلم عن نفسك", 
"ليه انت مش سالك", 
"ما هيا عيوب سورس همس؟ ", 
"اخر كتاب قرآته", 
"روايتك المفضله ?", 
"اخر اكله اكلتها", 
"اخر كتاب قرآته", 
"ليه المبرمج احمد المصريجدع؟ ", 
"افضل يوم ف حياتك", 
"ليه مضيفتش كل جهاتك", 
"حكمتك ف الحياه", 
"لون عيونك", 
...
"اكتب تاريخ مستحيل تنساه ",
  ...
  "فُرصه تتمنى لو أُتيحت لك ؟ ",
   "لي المبرمج احمد المصريناك اليكس؟ ",
  "شيء مستحيل ترفضه ؟. ",
...
if text == 'العاب همس' or text == 'العاب مطوره' or text == 'الالعاب' then  
local Text = [[  
 ⋆ اهلا في قائمه الالعاب المتطوره سورس همس ⋆ 
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/hms_00/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
if tonumber(result.sender_user_id_) == tonumber(11751768178) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(916165019) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(11751768178) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(916165019) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n ⋆ الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'hms_00')..')'
status  = '\n ⋆ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(11751768178) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(916165019) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Gold-So/hms/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⋆ اهلا بك في متجر ملفات همس\n ⋆ ملفات السورس ↓\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n☩━━━━━☩🌠𝘏𝘔𝘚🌠☩━━━━━☩\n ⋆ علامة تعني { ✔️ } ملف مفعل\n ⋆ علامة تعني { ✖ } ملف معطل\n ⋆ قناة سورس همس↓\n".." ⋆ [اضغط هنا لدخول](t.me/hms_00) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Gold-So/hms/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ⋆ عذرا الملف لايدعم سورس همس\n") 
end
return false
end
...
if text == ("مسح قائمه همس") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ⋆ تم مسح قائمه همس')
return false
end

if text == 'قائمه همس' and Sudo(msg) then
...
if text == ("رفع همس") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع همس@(.*)$") and Sudo(msg) then
local username = text:match("^رفع همس@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع همس(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع همس(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل همس") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل همس@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل همس@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل همس(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل همس(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, t..'☩━━━━━☩🌠𝘏𝘔𝘚🌠☩━━━━━☩\nاضغط علي الاسم ليتم نسخه\n☩━━━━━☩🌠𝘏𝘔𝘚🌠☩━━━━━☩ٴ\n ⋆ ❲[🌠𝘏𝘔𝘚🌠](t.me/hms_00)❳ ⋆ ')
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "همس")
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'همس').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'همس')
local DRAGON_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'همس')
local DRAGON_Msg = {
...
end --الكود حصري سورس همسيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'همس').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/hms_00)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/hms_00)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/hms_00)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/hms_00)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/hms_00)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/hms_00)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/hms_00)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/hms_00)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/hms_00)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/hms_00)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/hms_00)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/hms_00)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🌚♥️](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/hms_00)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🌚💕](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/hms_00)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚💕](t.me/hms_00)')
return false
end
end
end
...
local Teext =[[
 ⋆   بك في مميزات سورس همس ⋆  
 ⋆   مميزات الخاصه بسورس ⋆ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', url="https://t.me/hms_00/149"},{text = 'كتبات',url="https://t.me/hms_00/155"}},   
{{text = 'انصحني', url="https://t.me/hms_00/151"},{text = 'لو خيروك', url="https://t.me/hms_00/152"}}, 
{{text = 'الصراحه', url="https://t.me/hms_00/161"},{text = 'حروف', url="https://t.me/hms_00/153"}}, 
{{text = 'رزله', url="https://t.me/hms_00/156"},{text = 'رد عليه يابوت', url="https://t.me/hms_00/160"}}, 
{{text = 'بتكره دا', url="https://t.me/hms_00/157"},{text = 'نكته', url="https://t.me/hms_00/154"}}, 
{{text = 'غنيلي', url="https://t.me/hms_00/158"}},
{{text = 'نسبه جمالي', url="https://t.me/hms_00/188"},{text = 'اليتيوب', url="https://t.me/hms_00/194"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'لعبه البات', url="https://t.me/hms_00/138"},{text = 'لعبه الرياضيات',url="https://t.me/hms_00/139"}},   
{{text = 'لعبه المختلف', url="https://t.me/hms_00/148"},{text = 'لعبه السمايلات', url="https://t.me/hms_00/141"}}, 
{{text = 'لعبه التخمين', url="https://t.me/hms_00/143"},{text = 'لعبه العكس', url="https://t.me/hms_00/144"}}, 
{{text = 'لعبه الاسرع', url="https://t.me/hms_00/145"},{text = 'لعبه الانكليزي', url="https://t.me/hms_00/146"}}, 
{{text = 'لعبه حزوره', url="https://t.me/hms_00/142"},{text = 'لعبه المعاني', url="https://t.me/hms_00/147"}}, 
{{text = 'لعبه الامثله', url="https://t.me/hms_00/140"},{text = 'عقاب', url="https://t.me/hms_00/198"}},
{{text = 'مريم', url="https://t.me/hms_00/209"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '𝘏𝘔𝘚', url="t.me/hms_00"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'همس')
