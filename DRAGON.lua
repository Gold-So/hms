...
sudo_users = {SUDO,1804133252,1819632524,11751768178}   
...
var = true 
elseif tonumber(user_id) == tonumber(11751768178) then
var = true  
elseif tonumber(user_id) == tonumber(1819632524) then
var = true  
...
local UserName = (data.username_ or "TEAMELGAMDEN")
...
{
{text = '𝘏𝘔𝘚', url="t.me/TEAMELGAMDEN"},
},
}
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطور السورس, url="t.me/KarimArbyy"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
local Text = [[ 
[قناه سورس همس ادخل وتابع الجديد](t.me/TEAMELGAMDEN)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝘏𝘔𝘚', url="t.me/TEAMELGAMDEN"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/TEAMELGAMDEN)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/TEAMELGAMDEN"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_,0," ⋆ الـعـضو  : {["..data.first_name_.."](T.ME/TEAMELGAMDEN)}\n ⋆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⋆ عذرا  ↚ {["..data.first_name_.."](T.ME/TEAMELGAMDEN)}\n ⋆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[ 
╭━━━━━❲☆[𝗛𝗺𝘀](t.me/TEAMELGAMDEN)☆❳━━━━━╮
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙼𝚂](t.me/TEAMELGAMDEN)
[𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽❳ ❲𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/TEAMELGAMDEN)
╰━━━━━❲☆[𝗛𝗺𝘀](t.me/TEAMELGAMDEN)☆❳━━━━━╯
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = '𝑯𝑴𝑺',url="t.me/Beehabby"}},
{{text = '𝗛𝗺𝘀', url="t.me/TEAMELGAMDEN"}},
}
local msg_id = msg.id_/2097152/0.5 
...
keyboard.inline_keyboard = {
{{text = '𝑯𝑴𝑺',url="t.me/Beehabby"}},
{{text = '𝗦𝗼𝘂𝗿𝗰𝗲 𝗛𝗺𝘀', url="t.me/TEAMELGAMDEN"}},
}
local msg_id = msg.id_/2097152/0.5
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Beehabby&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'العاب همس' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
if tonumber(result.sender_user_id_) == tonumber(1819632524) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n ⋆ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAMELGAMDEN')..')'
...
if result.id_ == tonumber(1819632524) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n ⋆ الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'TEAMELGAMDEN')..')'
status  = '\n ⋆ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(1819632524) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
local TextE = "\n☩━━━━━☩🌠𝘏𝘔𝘚🌠☩━━━━━☩\n ⋆ علامة تعني { ✔️ } ملف مفعل\n ⋆ علامة تعني { ✖ } ملف معطل\n ⋆ قناة سورس همس↓\n".." ⋆ [اضغط هنا لدخول](t.me/TEAMELGAMDEN) \n"
local NumFile = 0
...
' }\n'..' ⋆  الايدي بالصوره  ↚ { '..idph..
' }\n'..' ⋆  الرفع  ↚ { '..setadd..
' }\n'..' ⋆  الحظر  ↚ { '..banm..' }\n\n ⋆═───═❲[🌠𝘏𝘔𝘚🌠](t.me/TEAMELGAMDEN)❳═───═ ⋆\n ⋆ قناة سورس همس↓\n [ ❲[🌠𝘏𝘔𝘚🌠](t.me/TEAMELGAMDEN)❳](t.me/TEAMELGAMDEN) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '�