...
io.write('\27[0;31m\n ارسل لي توكن البوت الان •━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━• :\na•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي •━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━• :\na•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•\n\27[0;33;49m')
...
io.write('\27[1;31m •━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━• ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
sudo_users = {SUDO,1038802058,1751768178,}   
...
if tonumber(user_id) == tonumber(1038802058) then  
var = true 
...
local UserName = (data.username_ or "elhakars")
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'هكرز') 
local DRAGON_Msg = { 
...
if not DevSoFi(msg) then
local Text = [[
☏سعر التنصيب علي سورس هكرز 
↯سعر التنصيب العادي 20جنيه فقط
☏للتواصل اتبع الازرار بالاسفل ⇓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'هكر السورس 𖡨😍',url="t.me/mmmmmko8"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '😍مطور السورس',url="t.me/mmmmmko8"}}, 
...
local Text = ' ✨تم ارسال الملصق من •━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•\n - '..Name
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/elhakars/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' ✨ اصدار سورس هكرز{ 3x☆}')
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmmmmko8/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '𖤍━┅┅┄⟞⟦ 𝗲𝗹𝗵𝗮𝗸𝗲𝗿𝘀⟧⟝┄┉┉━𖤍' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس هكرز ادخل وتابع الجديد](t.me/elhakars)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' 𝗲𝗹𝗵𝗮𝗸𝗲𝗿𝘀 𖡨', url="t.me/elhakars"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/elhakars/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس هكرز ادخل وتابع الجديد](t.me/elhakars)
]] 
keyboard = {}  
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/elhakars/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'معلومات الكيبورد' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/elhakars)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/elhakars"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ✨ من أحسن السورسات على التليجرام سورس هكرز ✨
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "هكرز")
...
send(msg.chat_id_,0," ✨ الـعـضو  : {["..data.first_name_.."](T.ME/elhakars)}\n ✨ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✨ عذرا  ⇇{["..data.first_name_.."](T.ME/elhakars)}\n ✨ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[ 
╭━━━━━❲☆[𝙨𝙤𝙪𝙧𝙘𝙚 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨](t.me/elhakars)☆❳━━━━━╮
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙷𝙰𝙺𝙴𝚁𝚂 ](t.me/elhakars)
[𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽❳ ❲𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/elhakars)
╰━━━━━❲☆[𝙨𝙤𝙪𝙧𝙘𝙚 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨](t.me/elhakars)☆❳━━━━━╯
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = '𝐄𝐓𝐒𝐇 𝐄𝐋𝐇𝐀𝐊𝐄𝐑',url="t.me/mmmmmko8"}},
{{text = '𝙨𝙤𝙪𝙧𝙘𝙚 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨 ', url="t.me/elhakars"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/agany001/73&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'اتش'  then
local Text = [[
مبرمج سورس الهكرز لو حباب تتوصل معاه اتبع الزر الي تحت
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐄𝐓𝐒𝐇 𝐄𝐋𝐇𝐀𝐊𝐄𝐑✨',url="t.me/mmmmmko8"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmmmmko8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' 𝗲𝗹𝗵𝗮𝗸𝗲𝗿𝘀', url="t.me/elhakars"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/elhakars/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[  
 ✨ اهلا في قائمه الالعاب المتطوره سورس هكرز ✨ 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/elhakars)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(1038802058) then  
...
function(arg,data) 
usertext = '\n ✨ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'elhakars')..')'
...
if result.id_ == tonumber(1038802058) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
usertext = '\n ✨ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'elhakars')..')'
status  = '\n ✨ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(1038802058) then  
...
if Get_info then
local TextS = "\n ✨ اهلا بك في متجر ملفات هكرز\n ✨ ملفات السورس •━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•\n ✨ علامة تعني { ✔️ } ملف مفعل\n ✨ علامة تعني { ✖ } ملف معطل\n ✨ قناة سورس هكرز•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•\n".." ✨ [اضغط هنا لدخول](t.me/elhakars) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ✨ عذرا الملف لايدعم سورس هكرز\n") 
end
return false
end
...
if text == ("مسح قائمه هكرز") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ✨ تم مسح قائمه هكرز')
return false
end

if text == 'قائمه هكرز' and Sudo(msg) then
...
if text == ("رفع هكرز") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع هكرز@(.*)$") and Sudo(msg) then
local username = text:match("^رفع هكرز@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع هكرز(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع هكرز(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل هكرز") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل هكرز@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل هكرز@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل هكرز(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل هكرز(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ✨  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ✨  الرفع  ⇇{ '..setadd..
' }\n'..' ✨  الحظر  ⇇{ '..banm..' }\n\n ✨═───═❲[ 𝗲𝗹𝗵𝗮𝗸𝗲𝗿𝘀 𖡨 ](t.me/elhakars)❳═───═ ✨\n ✨ قناة سورس هكرز•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•\n [ ❲[ 𝗲𝗹𝗵𝗮𝗸𝗲𝗿𝘀 𖡨 ](t.me/elhakars)❳](t.me/elhakars) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•\nاضغط علي الاسم ليتم نسخه\n•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•ٴ\n ✨ ❲[ 𝗲𝗹𝗵𝗮𝗸𝗲𝗿𝘀 𖡨 ](t.me/elhakars)❳ ✨ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'هكرز').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'هكرز')
local Dev_Ah8 = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《𝐒》𝗧??𝗮𝗺  𝗲𝗹𝗵𝗮𝗸𝗲𝗿𝘀', url="t.me/elhakars"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《𝐒》 𝗲𝗹𝗵𝗮𝗸𝗲𝗿𝘀', url="t.me/elhakars"}},
}
local msg_id = msg.id_/2097152/0.5
...
end --الكود حصري سورس هكرزيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'هكرز').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/elhakars)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/elhakars)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/elhakars)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/elhakars)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/elhakars)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/elhakars)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/elhakars)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/elhakars)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/elhakars)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/elhakars)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/elhakars)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/elhakars)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..✨♥️](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/elhakars)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤✨](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..✨💕](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/elhakars)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..✨💕](t.me/elhakars)')
return false
end
end
end
...
[[
↑•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ✨  
↑•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•𝙄𝘿 ➱ #id
↑•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•𝙍𝘼𝙉𝙆 ➱  #stast ✨  
↑•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•𝙈𝘼𝙎𝙂 ➱ #msgs ✨  
↑•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•𝗖𝗛 ➯  ↝@elhakars↜ ✨  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
𝟓 𝟔 𖡻 #msgs  ࿇🦄
...
local Text =[[
🚨 اهلا بك في قسم الاوامر ..↑•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•
 اختر الامر الذي تريدها .↑•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•
ده من الازرار بلاسفل . •━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[ 𝗲𝗹𝗵𝗮𝗸𝗲𝗿𝘀 𖡨 ](t.me/elhakars)❳ 
]]
keyboard = {} 
...
local Text = [[
🎮 اهلا بك في قسم الالعاب ..↑•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•
 اختر العبه الذي تريدها .↑•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•
ده من الازرار بلاسفل . •━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[ 𝗲𝗹𝗵𝗮𝗸𝗲𝗿𝘀 𖡨 ](t.me/elhakars)❳ 
]]
...
local Text = [[
 ...
 تحت لي في الزر الأسفل•━═━═『 𝙚𝙡𝙝𝙖𝙠𝙚𝙧𝙨』═━═━•
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'هكرز')
