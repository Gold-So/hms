...
sudo_users = {SUDO,1651342212,1751768178,1751768178}   
...
if tonumber(user_id) == tonumber(1651342212) then  
var = true 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'KAREM 𖡨😍',url="t.me/Beehabby"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '😍مطور السورس',url="t.me/Beehabby"}}, 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Beehabby/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/TEAMELGAMDEN/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/TEAMELGAMDEN/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/TEAMELGAMDEN)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(1651342212) then  
...
if result.id_ == tonumber(1651342212) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1651342212) then  
...
' }\n'..' 🌠  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 🌠  الرفع  ⇇{ '..setadd..
' }\n'..' 🌠  الحظر  ⇇{ '..banm..' }\n\n 🌠═───═❲[𝘏𝘔𝘚 𖡨 ](t.me/TEAMELGAMDEN)❳═───═ 🌠\n 🌠 قناة سورس همس•━═━═『𝘏𝘔𝘚』═━═━•\n [ ❲[𝘏𝘔𝘚 𖡨 ](t.me/TEAMELGAMDEN)❳](t.me/TEAMELGAMDEN) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨𝗦𝗢𝗨𝗥𝗖𝗘❩ ', url="t.me/TEAMELGAMDEN"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《𝐒》𝗧??𝗮𝗺 𝘏𝘔𝘚', url="t.me/TEAMELGAMDEN"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《𝐒》𝘏𝘔𝘚', url="t.me/TEAMELGAMDEN"}},
}
local msg_id = msg.id_/2097152/0.5
