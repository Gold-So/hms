...
local Text = [[ 
╭━━━━━❲☆[𝗦𝗼𝘂𝗿𝗰𝗲 𝗵𝗺𝘀](t.me/hms_00)☆❳━━━━━╮
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙼𝚂 ](t.me/hms_00)
[𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽❳ ❲𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/hms_00)
╰━━━━━❲☆[𝗦𝗼𝘂𝗿𝗰𝗲 𝗵𝗺𝘀](t.me/hms_00)☆❳━━━━━╯
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = ' 𝗵𝗺𝘀 “',url="t.me/hms_01"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙼𝚂', url="t.me/hms_00"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Dahab_source/4/25&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
